  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between text-black my-8 px-4 md:px-0">
      ...
      <div className="flex-1 md:pr-8 mb-6 md:mb-0 text-center md:text-left">
        ...
        <h3 className="text-3xl font-semibold mb-2 mx-12">I'm Anosha</h3>
        <p className="text-xl mb-4 mx-12">A Web Developer</p>
        <p className="text-base px-2 md:px-0 mx-12">
          Welcome to my web developer portfolio! I'm Anosha, a skilled and creative web developer with a passion for creating beautiful, responsive, and user-friendly websites. I've worked on a variety of web projects, ranging from personal blogs to e-commerce platforms.
        </p>
